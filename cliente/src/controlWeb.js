function ControlWeb($){
	...
	this.mostrarFuncion=function(){
		var cadena='<div id="funcionPartida">';
		cadena=cadena+'<div class="form-group">';
		cadena=cadena+'<label for="nick">Nick: ' + ws.nick + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>';
		if(ws.impostor){
			cadena=cadena+'<label for="encargo">Profesión: Impostor</label>';
		}else{
			cadena=cadena+'<label for="encargo">Profesión: Pendiente de encargo</label>';
		}
